  ...
  <div class="stage">
    <svg class="canvas" viewBox="0 0 800 460" role="group"
      ...
      <a href="https://github.com/radiantearth/stac-spec/blob/master/catalog-spec/catalog-spec.md"
         ...
         aria-label="Open the STAC Catalog specification in a new tab" @click.stop>
      <g class="node catalog">
        <rect x="43" y="116" width="171" height="148" rx="20" class="link-target" />
        <text x="128" y="156" text-anchor="middle" class="node-kind">CATALOG</text>
        <text x="128" y="193" text-anchor="middle" class="node-file link-label">catalog.json</text>
      ...
      <a href="https://github.com/radiantearth/stac-spec/blob/master/collection-spec/collection-spec.md"
         target="_blank" rel="noopener noreferrer" class="svg-source-link"
         aria-label="Open the STAC Collection specification in a new tab" @click.stop>
      <g class="node collection" :class="{ on: s >= 1 }">
        <rect x="281" y="96" width="194" height="188" rx="20" class="link-target" />
        <text x="378" y="138" text-anchor="middle" class="node-kind">COLLECTION</text>
        <text x="378" y="175" text-anchor="middle" class="node-file link-label">collection.json</text>
      ...
      <g class="node item" :class="{ on: s >= 2 }">
        <rect x="542" y="96" width="190" height="139" rx="20" class="link-target" />
        <text x="637" y="137" text-anchor="middle" class="node-kind">ITEM</text>
        <text x="637" y="173" text-anchor="middle" class="node-file link-label">item.json</text>
      ...
      <a href="https://github.com/radiantearth/stac-spec/blob/master/commons/assets.md"
         target="_blank" rel="noopener noreferrer" class="svg-source-link"
         aria-label="Open the STAC Asset specification in a new tab" @click.stop>
      <g class="node asset" :class="{ on: s >= 3 }">
        <rect x="542" y="296" width="190" height="116" rx="20" class="link-target" />
        <text x="637" y="337" text-anchor="middle" class="node-kind">ASSETS</text>
        <text x="637" y="370" text-anchor="middle" class="node-file link-label">*.parquet · *.tif</text>
