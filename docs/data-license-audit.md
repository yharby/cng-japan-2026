...
Only exact datasets with a **Green** result may appear as conversion, reuse, or pilot examples in the presentation. Catalog roots with mixed terms, sources that require extra permission or notification, and sources without a confirmed upstream redistribution grant stay out of the deck.
...
| [Fields of the World Global](https://data.source.coop/ftw/global-data/catalog.json), including the exact Japan Item and assets | **Green** | The vector collection and catalog declare CC BY 4.0. Credit Fields of the World, Taylor Geospatial Institute, and Microsoft AI for Good Research Lab; link the original and license and identify changes. |
...
| [GHSL Population catalog](https://data.source.coop/nlebovits/ghsl/catalog.json) | **Green** | All twelve exact collections declare CC BY 4.0 and identify the European Commission Joint Research Centre as producer/licensor. The registered catalog exposes 3,984 COG Items. Preserve JRC attribution, the collection license, product citation, conversion note, and source links. |
